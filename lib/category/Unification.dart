...
class Unification extends StatefulWidget {
  @override
  _UnificationState createState() => _UnificationState();
}

class _UnificationState extends State<Unification>
  ...
  Future<dynamic> getBooks() async {
    ...
    setState(() {
      ...
      filteredList = rest.where((val) => val["category"] == "unification");
